/*
  # Fix approve_task_with_quality - Add title to notifications
  
  1. Problem
    - Notifications table requires title column (NOT NULL)
    - Function only sets title_de, title_en, title_km
    - This causes constraint violation error
  
  2. Solution
    - Add title column to INSERT statement
...
BEGIN
  ...
  IF v_staff_id IS NOT NULL THEN
    ...
    -- Create notification with translations (ADDED title column)
