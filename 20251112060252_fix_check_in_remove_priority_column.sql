/*
  # Fix Check-In Notifications - Remove Priority Column

  1. Problem
    - process_check_in function uses 'priority' column that doesn't exist
    - Causing function to fail completely

  2. Solution
    - Remove priority column from notifications INSERT
