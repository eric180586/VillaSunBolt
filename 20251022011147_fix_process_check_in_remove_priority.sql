/*
  # Fix process_check_in - Remove Priority Column

  ## Problem:
  - Function tries to insert 'priority' column
  - Column doesn't exist in notifications table
  
  ## Solution:
  - Remove priority from INSERT statement
*/
...
BEGIN
  ...
  -- Send notification to ALL admins (without priority column)
