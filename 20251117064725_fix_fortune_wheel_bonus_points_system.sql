/*
  # Fix Fortune Wheel Bonus Points System
  
  1. Changes
    - Fix add_bonus_points to use correct column names
    - Allow users to add their own fortune wheel bonus points
    - Admin can still add manual bonus points
...
-- Create new function that works for both user fortune wheel and admin manual bonuses
