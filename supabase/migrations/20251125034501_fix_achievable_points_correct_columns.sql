/*
  # Fix Achievable Points - Correct Column Names

  1. Problem
    - Function uses ci.points_value but column is ci.points_awarded
    
  2. Solution
    - Update to use correct column name
    - Checklist instances use points_awarded, not points_value
*/
...
BEGIN
  ...
  -- 6. Checklist instances for today (use points_awarded, not points_value!)
