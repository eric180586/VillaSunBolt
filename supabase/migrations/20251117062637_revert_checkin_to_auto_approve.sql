/*
  # Revert Check-In to Auto-Approve
  
  1. Changes
    - Check-ins are automatically approved
    - Points awarded immediately
    - Fortune wheel appears immediately after check-in
    - Admin can modify points afterwards if needed
  
  2. Behavior
    - User checks in → auto approved → points awarded → fortune wheel
    - Admin can later adjust via CheckInApproval component
*/
...
BEGIN
  ...
  INSERT INTO points_history (
    ...
    p_user_id,
    v_points_awarded,
    CASE WHEN v_is_late THEN 'checkin_late' ELSE 'checkin_on_time' END,
    CASE 
