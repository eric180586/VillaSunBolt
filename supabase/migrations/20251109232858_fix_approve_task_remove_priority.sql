/*
  # Fix approve_task_with_quality - Remove priority from notification

  1. Changes
    - Remove priority column from notification insert
    - notifications table structure: id, user_id, title, message, type, is_read, link, created_at
    - priority column does not exist

  2. Notes
    - This is the final fix needed for task approval to work
*/
...
BEGIN
  ...
  -- Send notification to staff (no priority column)
  IF v_staff_id IS NOT NULL THEN
