/*
  # Fix approve_task_with_quality - Use correct points_history columns

  1. Changes
    - Use 'points_change' instead of 'points' column
    - Remove 'task_id' column reference (doesn't exist in points_history)
    - Remove 'category' column reference (points_history doesn't have it)

  2. Notes
    - points_history table structure: id, user_id, points_change, reason, category, created_by, created_at
    - The function was trying to insert into non-existent 'task_id' and wrong 'points' columns
*/
...
BEGIN
  ...
  -- Award points to primary staff (use points_change and created_by, no task_id or category)
  IF v_staff_id IS NOT NULL THEN
    INSERT INTO points_history (user_id, points_change, reason, created_by)
    VALUES (
      v_staff_id,
      v_total_points,
