/*
  # Fix approve_task - Use Correct review_quality Values

  1. Problem
    - Function uses 'excellent', 'good', 'poor'
    - But constraint only allows 'very_good', 'ready', 'not_ready'

  2. Solution
    - Update function to use correct values
    - Adjust quality bonus logic
*/
