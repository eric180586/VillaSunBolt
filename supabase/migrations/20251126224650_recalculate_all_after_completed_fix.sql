/*
  # Recalculate All Daily Goals After Completed Tasks Fix

  Updates all daily_point_goals to use the new logic where completed tasks
  still count towards achievable points.
*/
...
BEGIN
  RAISE NOTICE 'Recalculating all daily_point_goals with completed tasks included...';
