/*
  # Fix approve_task - Complete Rewrite with Correct Schema

  1. Problem
    - Function references many non-existent columns
    - points_history uses points_change not points
    - points_history uses reason not description

  2. Solution
    - Rewrite entire function to match actual database schema
*/
...
BEGIN
  ...
  -- Allowed values: 'very_good', 'ready', 'not_ready'
  ...
  -- Log the approval (if function exists)
  BEGIN
