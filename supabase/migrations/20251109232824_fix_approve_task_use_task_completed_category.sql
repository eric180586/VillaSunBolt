/*
  # Fix approve_task_with_quality - Use correct category value

  1. Changes
    - Use 'task_completed' instead of task.category for points_history
    - points_history.category constraint only allows: task_completed, bonus, deduction, achievement, other
    - task.category can be: room_cleaning, maintenance, etc which are NOT valid in points_history

  2. Notes
    - This is the root cause of the approval failure
    - Always use 'task_completed' for task approvals in points_history
*/
...
BEGIN
  ...
  -- Award points to primary staff - ALWAYS use 'task_completed' category
  ...
  -- Award 50% points to helper if exists - ALWAYS use 'task_completed' category
