/*
  # Fix Push Notification Trigger - Correct Supabase URL

  The trigger was using the wrong Supabase URL, causing "Couldn't resolve host name" error.
  Update to use the correct URL: https://mvkupvgqtjgegaulaztx.supabase.co
*/
...
'Trigger function that calls send-push-notification Edge Function via pg_net with correct URL';
