/*
  # Fix process_check_in with correct column names
  
  - profiles.total_points (not points)
  - points_history.points_change (not points)
  - points_history.reason (not description)
*/
