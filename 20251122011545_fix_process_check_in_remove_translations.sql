/*
  # Fix process_check_in - Remove broken notification_translations
  
  notification_translations is a template table, not a relation table.
  Remove all INSERT attempts to notification_translations.
*/
...
BEGIN
  ...
  EXCEPTION WHEN OTHERS THEN
    -- Push notification failed, but don't fail the whole check-in
