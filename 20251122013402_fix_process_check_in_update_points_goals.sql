/*
  # Fix process_check_in to update daily_point_goals
  
  The function was missing the call to update_daily_point_goals
  which calculates achievable and achieved points for the dashboard.
*/
