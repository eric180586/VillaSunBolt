/*
  # Fix approve_check_in to use correct category

  The points_history table only allows specific categories:
  - task_completed
  - bonus
  - deduction
  - achievement
  ...
  Change 'check_in' to 'bonus' (for positive points) or 'deduction' (for negative)
*/
